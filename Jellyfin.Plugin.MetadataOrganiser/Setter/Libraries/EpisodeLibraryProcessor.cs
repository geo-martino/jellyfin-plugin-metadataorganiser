...
/// <inheritdoc />
public class EpisodeLibraryProcessor : LibraryProcessor<Episode, VideoTagExtractor<Episode>>
{
    /// <inheritdoc cref="LibraryProcessor{Episode,EpisodeTagExtractor}"/>
    public EpisodeLibraryProcessor(
        ILibraryManager libraryManager,
        IMediaEncoder encoder,
        IConfigurationManager config,
        ILogger<EpisodeLibraryProcessor> loggerProcessor,
    ...
    /// <inheritdoc />
    protected override IEnumerable<Episode> GetItems() => this.LibraryManager
